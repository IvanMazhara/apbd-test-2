...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apbd_test_2.Models.Participation", b =>
                {
            ...
            modelBuilder.Entity("apbd_test_2.Models.Race", b =>
                {
            ...
            modelBuilder.Entity("apbd_test_2.Models.Racer", b =>
                {
                    b.Property<int>("RacerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("apbd_test_2.Models.Track", b =>
                {
            ...
            modelBuilder.Entity("apbd_test_2.Models.TrackRace", b =>
                {
                    b.Property<int>("TrackRaceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("apbd_test_2.Models.Participation", b =>
                {
                    b.HasOne("apbd_test_2.Models.Racer", "Racer")
                        .WithMany("Participations")
                        .HasForeignKey("RacerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apbd_test_2.Models.TrackRace", "TrackRace")
                        .WithMany("Participations")
            ...
            modelBuilder.Entity("apbd_test_2.Models.TrackRace", b =>
                {
                    b.HasOne("apbd_test_2.Models.Race", "Race")
                        .WithMany("TrackRaces")
                        .HasForeignKey("RaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apbd_test_2.Models.Track", "Track")
                        .WithMany("TrackRaces")
