        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BestFinishTimeInSeconds = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participation", x => new { x.RacerId, x.TrackRaceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Participation_Track_Race_TrackRaceId",
            ...
            migrationBuilder.InsertData(
                table: "Track_Race",
                columns: new[] { "TrackRaceId", "BestFinishTimeInSeconds", "Laps", "RaceId", "TrackId" },
                values: new object[,]
                {
                    { 1, 5460, 100, 1, 1 },
                    { 2, 6300, 123, 2, 2 }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participation_TrackRaceId",
                table: "Participation",
                column: "TrackRaceId");
